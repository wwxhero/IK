...
% This example uses a model of the KUKA LBR iiwa, a 7 degree-of-freedom robot
% manipulator. <docid:robotics_ref.bvlvwcs-1 |importrobot|> generates a <docid:robotics_ref.bvan8uq-1
% |rigidBodyTree|> model from a description stored in a Unified Robot Description
% Format (URDF) file.
...
for i_bodies = 1 : n_bodies
  joint_i = bodies{i_bodies}.Joint;
  fprintf('%s: [%4.2f %4.2f %4.2f]\n' ...
        , joint_i.Name ...
        , joint_i.JointAxis(1), joint_i.JointAxis(2), joint_i.JointAxis(3));
end
...
% frame to be approximately vertical, by placing the target far above the robot.
% The |iiwa_link_ee| frame is oriented such that this constraint aligns the gripper
% with the axis of the cup.
